...
INSERT INTO "new_Staff" ("canBeChildInstructor", "createdAt", "drivingCapacityBand", "email", "employmentStatus", "employmentType", "hasSevereBehaviorTraining", "id", "name", "permissionLevel", "phoneNumber", "primaryFacilityId", "updatedAt") SELECT "canBeChildInstructor", "createdAt", "drivingCapacityBand", "email", "employmentStatus", "employmentType", "hasSevereBehaviorTraining", "id", "name", "permissionLevel", "phoneNumber", "primaryFacilityId", "updatedAt" FROM "Staff";
DROP TABLE "Staff";
